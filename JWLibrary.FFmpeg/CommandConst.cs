namespace JWLibrary.FFmpeg
{
    public class CommandConst
    {
        ...
        {
            return @"-rtbufsize 2000M -f dshow -y -i video=""@videoSource"":audio=""@audioSource"" -vcodec libx264 -b:v 5M -r @framerate -threads @cpucore -c:v h264_nvenc -profile:v high -preset:v fast -pixel_format yuv420p -crf 29 -vf scale=1024:-1 -vf crop=@width:@height:@x:@y -acodec aac -ac 2 -ab 192k -ar @audioRate -ab 64k -tune zerolatency @option1 -f @format ""@filename""";
        }
