...
namespace JWLibrary.Pattern.TaskService {
    public class ValidateTaskService<TIAction, TAction, TRequest, TResult, TValidator> : TaskService<TIAction, TAction, TRequest,
            TResult>
        ...
        public override Task<TResult> ExecuteAsync() {
            var validateResult = _validator.Validate(Instance);
